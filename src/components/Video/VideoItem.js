    ...
    return (
        <div>
            ...
            <div class="aspect-w-16 aspect-h-9">
                <iframe title="My" src={video} width="470" height="360" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
            </div>
            <div class="max-w-screen-md md:w-3/4 mx-auto">
                <div class="flex-col space-y-2 items-center  p-4 bg-blue-800 rounded-xl">
                <div class="flex justify-between -mt-4 px-4 pt-5">
                <span
                  class="inline-block ring-4 bg-gray-500 ring-gray-800 rounded-full text-sm font-medium tracking-wide text-gray-100 px-3 pt-0.5"
                  >Tech</span
                >
                <span
              ...
              <div class="flex flex-row items-end h-full w-full px-4 mt-4">
                <div class="flex border-t border-gray-700 w-full py-4">
                  ...
                  <div class="flex items-center flex-shrink-0 px-2">
                    ...
                    <iframe title="My Daily Marathon Tracker" src={video} width="340" height="240" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
    
                    <iframe title="My Daily Marathon " src={video} width="340" height="240" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
    
                    <iframe title="My Daily" src={video} width="340" height="240" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                    </div>
